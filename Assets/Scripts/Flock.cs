            ...
            switch (SceneController.algorithm) {
                case 0:
                    ...
                    for (int i = 0; i < SceneController.flockSize; ++i)
                    {
                        ...
                        float x = velocity.x + (SceneController.c1 * Random.Range(0f, 1f) * (birds[i].pBest.x - position.x)) + (SceneController.c2 * Random.Range(0f, 1f) * (StateVector.gBest.x - position.x));
                        float y = velocity.y + (SceneController.c1 * Random.Range(0f, 1f) * (birds[i].pBest.y - position.y)) + (SceneController.c2 * Random.Range(0f, 1f) * (StateVector.gBest.y - position.y));
                        float z = velocity.z + (SceneController.c1 * Random.Range(0f, 1f) * (birds[i].pBest.z - position.z)) + (SceneController.c2 * Random.Range(0f, 1f) * (StateVector.gBest.z - position.z));
                ...
                case 1:
                    ...
                    for (int i = 0; i < SceneController.flockSize; ++i)
                    {
                        ...
                        // Handle PSO here
                        Vector3 velocity = birds[i].velocity;
                        float x = velocity.x + (SceneController.c1 * Random.Range(0f, 1f) * (birds[i].pBest.x - position.x)) + (SceneController.c2 * Random.Range(0f, 1f) * (birds[i].lBest.x - position.x));
                        float y = velocity.y + (SceneController.c1 * Random.Range(0f, 1f) * (birds[i].pBest.y - position.y)) + (SceneController.c2 * Random.Range(0f, 1f) * (birds[i].lBest.y - position.y));
                        float z = velocity.z + (SceneController.c1 * Random.Range(0f, 1f) * (birds[i].pBest.z - position.z)) + (SceneController.c2 * Random.Range(0f, 1f) * (birds[i].lBest.z - position.z));
                ...
                case 2:
                    ...
                    for (int i = 0; i < SceneController.flockSize; ++i)
                    {
                        ...
                        // Handle UPSO here
                        Vector3 velocity = birds[i].velocity;
                        float lx = velocity.x + (SceneController.c1 * Random.Range(0f, 1f) * (birds[i].pBest.x - position.x)) + (SceneController.c2 * Random.Range(0f, 1f) * (birds[i].lBest.x - position.x));
                        float ly = velocity.y + (SceneController.c1 * Random.Range(0f, 1f) * (birds[i].pBest.y - position.y)) + (SceneController.c2 * Random.Range(0f, 1f) * (birds[i].lBest.y - position.y));
                        float lz = velocity.z + (SceneController.c1 * Random.Range(0f, 1f) * (birds[i].pBest.z - position.z)) + (SceneController.c2 * Random.Range(0f, 1f) * (birds[i].lBest.z - position.z));
                        float gx = velocity.x + (SceneController.c1 * Random.Range(0f, 1f) * (birds[i].pBest.x - position.x)) + (SceneController.c2 * Random.Range(0f, 1f) * (StateVector.gBest.x - position.x));
                        float gy = velocity.y + (SceneController.c1 * Random.Range(0f, 1f) * (birds[i].pBest.y - position.y)) + (SceneController.c2 * Random.Range(0f, 1f) * (StateVector.gBest.y - position.y));
                        float gz = velocity.z + (SceneController.c1 * Random.Range(0f, 1f) * (birds[i].pBest.z - position.z)) + (SceneController.c2 * Random.Range(0f, 1f) * (StateVector.gBest.z - position.z));
                        ...
                        if (nearestNeighborDistance < minDistance) {
                            ...
                            float ux = gx + (1 - SceneController.u) * lx;
                            float uy = gy + (1 - SceneController.u) * ly;
                            float uz = gz + (1 - SceneController.u) * lz;
